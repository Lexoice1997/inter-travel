    ...
    <section className="sm:mt-24 mt-16">
      ...
      <div className="flex justify-between sm:mt-14 mt-8">
        <Image
          ...
          className="sm:w-1/3 w-full sm:h-[500px] h-[350px] bg-gray-600 sm:mr-6 mr-0 rounded-xl"
        />
        <Image
          src={about2}
          alt="Picture of the author"
          className="sm:w-1/3 h-[500px] bg-gray-600 mr-6 rounded-xl hidden sm:block"
        />
        <Image
          src={about3}
          alt="Picture of the author"
          className="sm:w-1/3 h-[500px] bg-gray-600 rounded-xl hidden sm:block"
        />
      </div>
